...
Route::prefix('customer/service-bookings')->group(function(){
    ...
    Route::middleware('auth:api')->group(function(){Route::get('/',[ServiceBookingCustomerController::class,'index']);Route::post('/',[ServiceBookingCustomerController::class,'store']);Route::get('{booking}',[ServiceBookingCustomerController::class,'show']);Route::post('{booking}/accept-quote',[ServiceBookingCustomerController::class,'acceptQuote']);Route::post('{booking}/payment',[ServiceBookingCustomerController::class,'pay'])->middleware('throttle:10,1,service-bookings-payment');Route::post('{booking}/confirm',[ServiceBookingCustomerController::class,'confirm']);Route::post('{booking}/cancel',[ServiceBookingCustomerController::class,'cancel']);Route::post('{booking}/reschedule',[ServiceBookingCustomerController::class,'reschedule']);Route::post('{booking}/review',[ServiceBookingCustomerController::class,'review']);});
