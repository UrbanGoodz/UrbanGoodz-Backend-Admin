...
Route::group(['prefix' => 'order-anywhere', 'middleware' => ['auth:api', 'throttle:60,1']], function () {
    ...
    Route::post('requests/{record}/cancel', 'Api\V1\OrderAnywhereController@cancelRequest');
    Route::post('requests/{record}/test-payment', 'Api\V1\OrderAnywhereController@testPayment');
