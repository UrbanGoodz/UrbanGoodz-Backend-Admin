...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth', 'middleware' => 'throttle:10,1,auth-customer'], function () {
        ...
        Route::group(['prefix' => 'delivery-man','middleware' => ['actch:deliveryman_app', 'throttle:5,1,auth-delivery-man']], function () {
        ...
        Route::group(['prefix' => 'vendor','middleware' => ['actch:vendor_app', 'throttle:5,1,auth-vendor']], function () {
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware'=>['vendor.api','actch:vendor_app']], function () {
        ...
        Route::get('notifications/unread-count', 'VendorNotificationController@unreadCount');
        Route::post('notifications/{notificationId}/read', 'VendorNotificationController@markRead');
        Route::post('notifications/read-all', 'VendorNotificationController@markAllRead');
        Route::delete('notifications/{notificationId}', 'VendorNotificationController@destroy');
