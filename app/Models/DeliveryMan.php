...
class DeliveryMan extends Authenticatable
{
    ...
    protected $casts = [
        ...
        'has_medical_courier_training' => 'boolean',
        'has_liftgate' => 'boolean',
        'preferred_zones' => 'array',
        'preferred_work_types' => 'array',
        'capability_tags' => 'array',
        'available_for_business_courier' => 'boolean',
        'available_for_package_routes' => 'boolean',
        'available_for_order_anywhere' => 'boolean',
        'available_for_medical_courier' => 'boolean',
        'has_trailer' => 'boolean',
        'trailer_length_feet' => 'float',
        'trailer_width_feet' => 'float',
        'trailer_capacity_lbs' => 'float',
        'trailer_registration_expiration' => 'date',
        'trailer_insurance_expiration' => 'date',
        'has_pallet_jack' => 'boolean',
        'has_hazmat' => 'boolean',
        'has_cargo_insurance' => 'boolean',
        'cargo_insurance_expiration' => 'date',
        'max_payload_lbs' => 'float',
        'cargo_length_inches' => 'float',
        'cargo_width_inches' => 'float',
        'cargo_height_inches' => 'float',
