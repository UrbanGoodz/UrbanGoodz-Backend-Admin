...
class UrbanGoodzStrandedRequest extends Model
{
    ...
    protected $fillable = [
        ...
        'reward_offer_minor', 'escrow_status', 'escrow_transaction_id', 'reward_hold_transaction_id', 'escrow_released_at',
        ...
        'escalation_due_at', 'escalated_at', 'stall_alert_sent_at',
