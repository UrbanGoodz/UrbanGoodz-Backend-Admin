...
class UrbanGoodzAdminController extends Controller
{
    ...
    private function sections(): array
    {
        return [
            ...
            'logistics' => [
                'title' => 'Logistics',
                'url' => route('admin.urban-goodz.load-board.index'),
                'status' => 'Live',
                'table' => 'urban_goodz_load_board_loads',
                'revenue' => true,
                'reportable' => true,
                'admin_workflow' => 'Load board CRUD, status transitions, assignment, pricing, audit. Business portal, dispatcher, driver workflows.',
            ],
            'medical-courier' => [
                'title' => 'Medical Courier',
                'url' => route('admin.urban-goodz.medical-courier.index'),
                'status' => 'Live',
                'table' => 'urban_goodz_medical_courier_jobs',
                'revenue' => true,
                'reportable' => true,
                'admin_workflow' => 'Courier jobs, custody logs, chain-of-custody tracking, qualified driver matching.',
            ],
            'events' => [
                'title' => 'Events',
