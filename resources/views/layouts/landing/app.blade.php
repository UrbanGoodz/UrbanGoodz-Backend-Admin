...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/landing/css/ug-landing.css') }}"/>
    ...
    <style>
        :root {
            ...
            --primary-rgb: {{ $backgroundChange['primary_1_rgb'] ?? '237,153,20' }};
        }
    </style>
    @else
    <style>
                ...
                <div class="join-wrap">
                    ...
                    <div class="join-dd">
                        ...
                        <a href="{{ route('restaurant.create') }}" class="{{ Request::is('vendor*') ? 'active' : '' }}">
                            <span class="ji" style="background:rgba(237,153,20,.1);color:#ED9914;">&#x1F3EA;</span>
