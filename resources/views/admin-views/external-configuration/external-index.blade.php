                        ...
                        <div class="card-body">
                            ...
                            <div class="border rounded d-flex flex-wrap gap-2 align-items-center p-3 p-sm-4">
                                <div class="w-160px flex-grow-1">
                                    ...
                                    <p class="fs-12 m-0">
                                        {{translate('Enable the switch to activate the purchased Software- Drivemond ride-sharing in the system. You must input the correct information to make sure the functionality works properly.')}}
                                    </p>
                                </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 pt-0 px-lg-5">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="">
                                    ...
                                    <h5 class="mb-2">{{(\App\CentralLogics\Helpers::get_business_data('business_name') ?? "Urban Goodz" ) . ' ' .translate('System Token Generate')}}</h5>
                                    <p>
                                        ...
                                        {{(\App\CentralLogics\Helpers::get_business_data('business_name') ?? "Urban Goodz" ) . ' ' .translate('System Token Generate')}}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="pb-1">
                            <i class="text-dark">{{translate('Note :  Follow the same steps on Drivemond to successfully connect Urban Goodz with Drivemond')}}</i>
                        </div>
                    </div>
                </div>
            </div>
