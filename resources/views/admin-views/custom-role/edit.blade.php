                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="bg-light2 rounded sub_slect_all_wrapper h-100 mb-20">
                                                ...
                                                <div class="p-xxl-20 p-3 d-flex flex-wrap gap-3">
                                                    ...
                                                    <div class="check-item m-0 p-0"><div class="form-group m-0 form-check form--check"><input type="checkbox" name="modules[]" value="urban_goodz_order_anywhere_request_card" class="form-check-input" id="ug_oa_request_card_edit" {{in_array('urban_goodz_order_anywhere_request_card',(array)json_decode($role['modules']))?'checked':''}}><label class="form-check-label ps--3 qcont text-dark opacity-70" for="ug_oa_request_card_edit">{{ translate('Request Purchase Card') }}</label></div></div>
                                                    <div class="check-item m-0 p-0"><div class="form-group m-0 form-check form--check"><input type="checkbox" name="modules[]" value="urban_goodz_order_anywhere_freeze_card" class="form-check-input" id="ug_oa_freeze_card_edit" {{in_array('urban_goodz_order_anywhere_freeze_card',(array)json_decode($role['modules']))?'checked':''}}><label class="form-check-label ps--3 qcont text-dark opacity-70" for="ug_oa_freeze_card_edit">{{ translate('Freeze Purchase Card') }}</label></div></div>
                                                    <div class="check-item m-0 p-0"><div class="form-group m-0 form-check form--check"><input type="checkbox" name="modules[]" value="urban_goodz_order_anywhere_cancel_card" class="form-check-input" id="ug_oa_cancel_card_edit" {{in_array('urban_goodz_order_anywhere_cancel_card',(array)json_decode($role['modules']))?'checked':''}}><label class="form-check-label ps--3 qcont text-dark opacity-70" for="ug_oa_cancel_card_edit">{{ translate('Cancel Purchase Card') }}</label></div></div>
                                                    <div class="check-item m-0 p-0"><div class="form-group m-0 form-check form--check"><input type="checkbox" name="modules[]" value="urban_goodz_order_anywhere_reconcile_card" class="form-check-input" id="ug_oa_reconcile_card_edit" {{in_array('urban_goodz_order_anywhere_reconcile_card',(array)json_decode($role['modules']))?'checked':''}}><label class="form-check-label ps--3 qcont text-dark opacity-70" for="ug_oa_reconcile_card_edit">{{ translate('Reconcile Purchase Card') }}</label></div></div>
                                            ...
                                            <div class="bg-light2 rounded sub_slect_all_wrapper h-100 mb-20">
                                                ...
                                                <div class="p-xxl-20 p-3 d-flex flex-wrap gap-3">
                                                    ...
                                                    <div class="check-item m-0 p-0"><div class="form-group m-0 form-check form--check"><input type="checkbox" name="modules[]" value="urban_goodz_fleet_operations_view" class="form-check-input" id="ug_fleet_ops_view_edit" {{in_array('urban_goodz_fleet_operations_view',(array)json_decode($role['modules']))?'checked':''}}><label class="form-check-label ps--3 qcont text-dark opacity-70" for="ug_fleet_ops_view_edit">{{ translate('View Fleet Operations') }}</label></div></div>
                                                </div>
                                            </div>
