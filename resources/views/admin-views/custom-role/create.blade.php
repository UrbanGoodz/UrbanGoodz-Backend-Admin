                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="bg-light2 rounded sub_slect_all_wrapper h-100 mb-20">
                                                ...
                                                <div class="p-xxl-20 p-3 d-flex flex-wrap gap-3">
                                                    ...
                                                    <div class="check-item m-0 p-0"><div class="form-group m-0 form-check form--check"><input type="checkbox" name="modules[]" value="urban_goodz_financial_control_view" class="form-check-input" id="ug_fin_control_view"><label class="form-check-label ps--3 qcont text-dark opacity-70" for="ug_fin_control_view">{{ translate('View Financial Control Center') }}</label></div></div>
                                                    <div class="check-item m-0 p-0"><div class="form-group m-0 form-check form--check"><input type="checkbox" name="modules[]" value="urban_goodz_financial_control_manage" class="form-check-input" id="ug_fin_control_manage"><label class="form-check-label ps--3 qcont text-dark opacity-70" for="ug_fin_control_manage">{{ translate('Manage Financial Control Center') }} <span class="text-danger">*</span></label></div></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="bg-light2 rounded sub_slect_all_wrapper h-100 mb-20">
                                                ...
                                                <div class="p-xxl-20 p-3 d-flex flex-wrap gap-3">
                                                    ...
                                                    <div class="check-item m-0 p-0"><div class="form-group m-0 form-check form--check"><input type="checkbox" name="modules[]" value="urban_goodz_fleet_operations_view" class="form-check-input" id="ug_fleet_ops_view"><label class="form-check-label ps--3 qcont text-dark opacity-70" for="ug_fleet_ops_view">{{ translate('View Fleet Operations') }}</label></div></div>
                                                </div>
                                            </div>
