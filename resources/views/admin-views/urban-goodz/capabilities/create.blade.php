...
@section('title', translate('Add Capability'))
...
@section('content')
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-sm-0">
                    <h1 class="page-header-title">{{ translate('Add Capability') }}</h1>
                </div>
        ...
        <form action="{{ route('admin.urban-goodz.capabilities.store') }}" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" class="form-control" value="{{ old('slug') }}" required placeholder="e.g. direct-checkout">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="input-label">{{ translate('Group') }}</label>
                                <input type="text" name="group" class="form-control" value="{{ old('group') }}" list="groupList" placeholder="e.g. fulfillment">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="admin_section_key" class="form-control" value="{{ old('admin_section_key') }}" list="sectionKeyList">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-0">
                                <label class="toggle-switch my-0">
                                    <input type="checkbox" name="is_core" class="toggle-switch-input" value="1">
