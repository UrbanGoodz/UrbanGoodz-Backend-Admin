...
@section('title', translate('Stranded — Live Operations'))
    ...
    <div class="row align-items-center">
      <div class="col-sm mb-2 mb-sm-0">
        ...
        <p class="text-muted mb-0">
          Active rescues and responders in your operational zone.
        ...
        @foreach ([
          ...
          <div class="col-6 col-md-3 col-xl">
            <div class="ug-live-stat">
              ...
              <div class="k">{{ translate($s['label']) }}</div>
            </div>
          </div>
        @endforeach
      </div>
...
<script>
(function () {
  var FEED = "{{ route('vendor.urban-goodz.stranded.live-feed') }}";
  ...
  window.ugStrandedVendorInitMap = function () {
...
@if (!empty($mapKey))
<script async defer
  src="https://maps.googleapis.com/maps/api/js?key={{ $mapKey }}&callback=ugStrandedVendorInitMap&v=3.61"></script>
@endif
@endpush
