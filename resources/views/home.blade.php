    ...
    <section class="ug-section ug-section--light">
        <div class="container">
            ...
            <div class="ug-cards-grid ug-cards-grid--10">
                <div class="ug-card">
                    <div class="card-icon"><img src="{{ asset('/public/assets/landing/img/module-images/retail-shopping.png') }}" alt="Retail & Shopping" /></div>
                    <h4>Retail &amp; Shopping</h4>
                    <p>Shop local stores, browse products, order for pickup or delivery</p>
                </div>
                <div class="ug-card">
                    <div class="card-icon"><img src="{{ asset('/public/assets/landing/img/module-images/beauty-supply.png') }}" alt="Beauty Supply" /></div>
                    <h4>Beauty Supply / Hair Providerz</h4>
                    <p>Book appointments, shop products, find local stylists</p>
                </div>
                <div class="ug-card">
                    <div class="card-icon"><img src="{{ asset('/public/assets/landing/img/module-images/grocery-markets.png') }}" alt="Food & Grocery" /></div>
                    <h4>Food &amp; Grocery</h4>
                    <p>Order meals and groceries from nearby restaurants and markets</p>
                </div>
                <div class="ug-card">
                    <div class="card-icon"><img src="{{ asset('/public/assets/landing/img/module-images/rental.png') }}" alt="Rentals" /></div>
                    <h4>Rentals</h4>
                ...
                <div class="ug-card">
                    <div class="card-icon"><img src="{{ asset('/public/assets/landing/img/module-images/local-events-creators.png') }}" alt="Events & Creators" /></div>
                    <h4>Events &amp; Creators</h4>
                    <p>Discover local events, support creators, book talent</p>
                </div>
                <div class="ug-card">
                    <div class="card-icon"><img src="{{ asset('/public/assets/landing/img/module-images/courier-delivery.png') }}" alt="Courier & Delivery" /></div>
