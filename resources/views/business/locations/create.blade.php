...
@section('title', translate('Add Location'))

@section('content')
    <div class="page-header d-flex flex-wrap align-items-center justify-content-between gap-2">
        <h1 class="page-header-title">{{ translate('Add Location') }}</h1>
        ...
        <div class="card-body">
            <form action="{{ route('business.locations.store') }}" method="POST">
                ...
                <div class="d-flex justify-content-end mt-3">
                    ...
                    <button type="submit" class="btn btn--primary">{{ translate('Save Location') }}</button>
                </div>
            </form>
        </div>
    </div>
