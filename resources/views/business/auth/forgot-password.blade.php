    ...
    <div class="auth-wrapper">
        <div class="auth-wrapper-left">
            <div class="auth-left-cont">
                ...
                <p style="color: rgba(255,255,255,.85);">{{ translate('Enter your email to receive a password reset link.') }}</p>
            </div>
        </div>
        <div class="auth-wrapper-right">
            <div class="auth-wrapper-form">
                <div class="auth-header">
                    <div class="mb-5">
                        <h2 class="title" style="color: var(--ug-black); font-weight: 700;">{{ translate('Forgot Password') }}</h2>
                        <div style="color: #6c757d;">{{ translate('We\'ll send you a link to reset your password') }}.</div>
                    </div>
                </div>
